    ...
    return (
        <div className='skills-section section'>
            ...
            <SkillCard heading='Frontend' skills={[
                ...
                { 'name': 'JavaScript', 'prefix': 'javascript' , 'icon': 'javascript-original' },
                { 'name': 'React', 'prefix': 'react' , 'icon': 'react-original' },
                { 'name': 'Bootstrap', 'prefix': 'bootstrap' , 'icon': 'bootstrap-original' },
                { 'name': 'Tailwind CSS', 'prefix': 'tailwindcss' , 'icon': 'tailwindcss-original' },
                { 'name': 'Material-UI', 'prefix': 'materialui' , 'icon': 'materialui-original' },
            ]} />
            <SkillCard heading='Backend' hcolor="var(--clr-accent2)" skills={[
                ...
                { 'name': 'ASP.NET', 'prefix': 'dotnetcore' , 'icon': 'dotnetcore-original' },
                { 'name': 'Javascript', 'prefix': 'javascript' , 'icon': 'javascript-original' },
                ...
                { 'name': 'MS SQL', 'prefix': 'microsoftsqlserver' , 'icon': 'microsoftsqlserver-original' },
            ...
            <SkillCard heading='Tools' hcolor="var(--clr-accent3)" skills={[
                ...
                { 'name': 'Android Studio', 'prefix': 'androidstudio' , 'icon': 'androidstudio-original' },
                { 'name': 'Visual Studio', 'prefix': 'visualstudio' , 'icon': 'visualstudio-original' },
                ...
                { 'name': 'AWS', 'prefix': 'amazonwebservices' , 'icon': 'amazonwebservices-original-wordmark' },

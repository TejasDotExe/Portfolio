    ...
    <div className='skill-card' style={{ '--clr': hcolor, color: 'var(--clr)' }}>
      ...
      <ul className='skill-list'>
        {skills.map((skill, index) => (
          <li key={index}>
            {skill.icon && <img src={skill.icon.startsWith('https://') ? skill.icon : `https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/${skill.prefix}/${skill.icon}.svg`} alt={skill.name} width="16px" height="16px" />}
